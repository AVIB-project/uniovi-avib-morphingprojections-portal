...
const routes: Routes = [
    {
        ...
        children: [
            ...
            { path: 'configuration', data: { breadcrumb: 'Annotation' }, loadChildren: () => import('./views/configuration/configuration.module').then(m => m.ConfigurationModule) },
            { path: 'configuration-form', data: { breadcrumb: 'Annotation Form' }, loadChildren: () => import('./views/configuration-form/configuration-form.module').then(m => m.ConfigurationFormModule) },
