    ...
    private getEncodingAnnotations(projection?: string) {
        ...
        .subscribe({
            ...
            annotations.forEach((annotation: Annotation) => {
                ...
                this.sampleEncodedAnnotationsGrouped.push(this.annotationService.getAnnotations().filter((encodedAnnotation: Annotation) =>
                encodedAnnotation.encodingName == annotation.name));
            });
            }        
        })
    } 
