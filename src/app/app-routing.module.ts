...
const routes: Routes = [
    {
        ...
        children: [
            ...
            { path: 'encoding-form', data: { breadcrumb: 'Encoding Form', roles: ['ADMIN', 'USER'] }, canActivate: [AuthGuard], loadChildren: () => import('./views/encoding-form /encoding-form.module').then(m => m.EncodingFormModule) },
